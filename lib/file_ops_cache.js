 ...
 * 
 * This is a default (stopgap) caching object, provided to act as the cache. But, a more robust verision this object may be 
...
class FileOperationsCache extends FileOperations {
     ...
     * 
     * @param {*} path -- a path to the directory to be created
     * 
     * @returns 
     */
     ...
     * 
     * @param {*} upath -- a path to the directory to be removed
     * @param {*} recursive -- from fsPromises 'rm' -- will remove subdirectories if true
     * @param {*} force -- from fsPromises 'rm' -- will remove directories and override stoppage conditions if tru
     * 
     * @returns 
     */
     ...
     * 
     * 
     * @param {*} path_1 -- source path
     * @param {*} path_2 -- destination path
     * @returns boolean
     */
     ...
     * 
     * 
     * @param {*} path -- a path to the file that will contain the string
     * @param {*} str -- a string to be written
     * @param {*} ce_flags -- options -- refer to the flags for node.js writeFile having to do with permissions, format, etc.
     * @returns 
     */
     ...
     * 
     * @param {*} path -- a path to the file that will contain the string
     * @param {*} obj -- a JSON stringifiable object
     * @param {*} ce_flags -- options -- refer to the flags for node.js writeFile having to do with permissions, format, etc.
